  ...
  useEffect(() => {
    (async () => {
      const response = await http.get<ProductList[]>(
        `http://192.168.100.159:8080/api/product/top-favorite`
      );
            ...
            {topTent &&
              topTent.map((tent) => (
                ...
                >
                  ...
                  <img
                    src={`http://192.168.100.159:8080/api/product/files/${tent.mainImageUuidName}`}
                  />
            ...
            {topTable &&
              topTable.map((table) => (
                ...
                >
                  ...
                  <img
                    src={`http://192.168.100.159:8080/api/product/files/${table.mainImageUuidName}`}
                  />
            ...
            {topTableware &&
              topTableware.map((tableware) => (
                ...
                >
                  ...
                  <img
                    src={`http://192.168.100.159:8080/api/product/files/${tableware.mainImageUuidName}`}
                  />
            ...
            {topAccessory &&
              topAccessory.map((accessory) => (
                ...
                >
                  ...
                  <img
                    src={`http://192.168.100.159:8080/api/product/files/${accessory.mainImageUuidName}`}
                  />
            ...
            {topOther &&
              topOther.map((other) => (
                ...
                >
                  ...
                  <img
                    src={`http://192.168.100.159:8080/api/product/files/${other.mainImageUuidName}`}
                  />
