...
import { Container, Editinput, Editdiv, Select, P, Button, Buttondiv, Editp } from './styles';
                ...
                {user.map((userData, id) => (
                    <div key={id}>
                        <Editdiv style={{ marginTop: '2vh' }}>
                            <Editp>이름</Editp>
                            <Editinput ref={nameRef} type="text" name="username" defaultValue={userData.username} />
                        </Editdiv>
                        <Editdiv>
                            <Editp>닉네임</Editp>
                            <Editinput ref={nicknameRef} type="text" defaultValue={userData.nickname} name="nickname" />
                        </Editdiv>
                        <Editdiv>
                            <Editp>성별</Editp>
                            <div
                            ...
                            >
                                <label>
                                    <input type="radio" name="male" onChange={handlecheck} value="male" ref={sexRef} />
                                    남성
                                </label>
                                <label>
                                    <input type="radio" onChange={handlecheck} value="female" ref={sexRef} />
                                    여성
                                </label>
                            </div>
                        </Editdiv>
                        <Editdiv>
                            <Editp>생년월일</Editp>
                            <Editinput type="date" defaultValue={userData.birth} name="birth" ref={birthRef} />
                        </Editdiv>
                        <Editdiv>
                            <Editp>한줄소개</Editp>
                            <Editinput
                        ...
                        <Editdiv>
                            <Editp>프로필 이미지</Editp>
                            <img src={require('../../../../../../components/market/Header/logo.png')} alt="" />
                        </Editdiv>
                    </div>
                ))}
                <Buttondiv>
