...
import { Container, Editinput, Editdiv, Select, P, Button, Buttondiv, Editp, Seconddiv } from './styles';
...
const EditProfile = () => {
    ...
    const profileEdit = async (e) => {
        ...
        location.reload();
        const response = await http.put(`http://localhost:8080/user/update`, formData);
    };
                    ...
                    {user.map((userData, id) => (
                        <div key={id} style={{ width: '100%' }}>
                            ...
                            <Seconddiv>
                                ...
                                <Editdiv>
                                    <Editp>생년월일</Editp>
                                    <Editinput type="text" defaultValue={userData.birth} name="birth" ref={birthRef} />
                                </Editdiv>
                            </Seconddiv>
                            <Seconddiv>
                                <Editdiv>
                                ...
                                >
                                    <Editp style={{ margin: '0px', width: '70px', padding: '0px 0px 10px 10px' }}>
                                        프로필
                                        <br />
                                        <br /> 이미지
                                    </Editp>

                                    <input type="file" multiple accept="image/*" ref={imageRef} className="inputimg" />
                                </Editdiv>
                            </Seconddiv>
                        </div>
                    ))}
