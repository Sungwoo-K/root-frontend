...
import { Button, Categorydiv, Container, Icon, Keydiv, Linkdiv, Profilecontain, Profilediv } from './styles';
            ...
            <Container>
                <Profilediv>
                    <div className="profilediv">
                        <img className="profileimg" src={require('@/components/market/Header/tent.png')} />
                    </div>
